...
// ids stay as USD ranges (the DB stores USD); labels are shown in INR.
const PRICES = [
  { id: "0-50", label: `${formatINR(0)} - ${formatINR(50)}` },
  { id: "50-100", label: `${formatINR(50)} - ${formatINR(100)}` },
  { id: "100-150", label: `${formatINR(100)} - ${formatINR(150)}` },
  { id: "150-", label: `Over ${formatINR(150)}` },
] as const;
